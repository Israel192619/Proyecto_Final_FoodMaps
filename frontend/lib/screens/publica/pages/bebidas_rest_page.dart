...
class BebidasRest extends StatelessWidget {
  ...
  const BebidasRest({Key? key, required this.productos, this.updatesStream}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return isWideScreen
      ? GridView.builder(
          ...
          itemBuilder: (context, index) => _buildBebidaCard(
            context,
            productos[index],
            isDark,
            isWideScreen,
  ...
  // Construye una tarjeta de bebida para cualquier layout
  Widget _buildBebidaCard(
        ...
        children: [
          ...
          Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? Colors.grey[800]?.withOpacity(0.3) : Colors.blue.shade50,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
